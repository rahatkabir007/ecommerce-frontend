  ...
  return (
    <div>
      <div className="tracking-page-wrapper w-full">
        ...
        <div className="content-wrapper w-full mb-[40px] b-[40px] ">
          <div className="container-x mx-auto px-2">
            ...
            <div className="w-full bg-white lg:px-[30px] px-5 py-[23px] lg:flex items-center">
              <div className="lg:w-[642px] w-full">
                  ...
                  <div className="input-com w-full h-full">
                    ...
                    <div className="input-wrapper border  w-full h-full overflow-hidden relative border-qgray-border">
                      <input
                        ...
                        onBlur={(e) => setOrderSlug(e.target.value)}
                ...
                <button onClick={handleTrackingOrder} type="button">
                  <div className="w-[142px] h-[50px] bg-black text-white flex justify-center items-center">
                    <span>Track Now</span>
                  </div>
                </button>

                {trackingError && (
                  <span className="block text-sm font-semibold mt-2 text-qred">
                    {trackingError}
                  </span>
                )}
              </div>
