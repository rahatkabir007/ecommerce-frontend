...
const TermsAndConditions: React.FC<Props> = (props) => {
  ...
  return (
    <div className="bg-white">
      ...
      />
      <div className="w-full min-h-screen mt-10 pt-0 pb-0 p-3">
        <div className="container-x mx-auto">
          <p className="text-sm text-qgray">
            Welcome to
            <span className="bg-[#FFFAEF]"> Website Name</span>!
          </p>
          <p className="text-sm text-qgray py-5">
          ...
          <p className="text-sm text-qgray py-2 leading-8">
            ...
            <span className="bg-[#FFFAEF]"> Website Name</span>, you agreed to
          ...
          <p className="text-sm text-qgray py-2 leading-8">
            ...
            material on
            <span className="bg-[#FFFAEF]"> Website Name</span>. All
            intellectual property rights are reserved. You may access this from
            <span className="bg-[#FFFAEF]"> Website Name </span>
            for your own personal use subjected to restrictions set in these
            terms and conditions.
          </p>
          <p className="text-sm text-qgray py-2 leading-8">You must not:</p>
          ...
          <p className="text-sm text-qgray py-2 leading-8">
            You hereby grant
            <span className="bg-[#FFFAEF]"> Company Name </span>a non-exclusive
          ...
          <p className="text-sm text-qgray py-2 leading-8">
            ...
            <span className="bg-[#FFFAEF]"> Company Name </span>; and (d) the
          ...
          <p className="text-sm text-qgray py-2 leading-8">
            ...
            <span className="bg-[#FFFAEF]"> Company Name </span>. Please include
