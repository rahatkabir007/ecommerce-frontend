...
const TermsAndConditions: React.FC<Props> = (props) => {
    ...
    return (
        <div className='bg-white'>
            <PageHeader slug="Terms And Conditions" link="/termsandconditions" title="Terms and Condition" />
            <div className='w-full min-h-screen mt-10 pt-0 pb-0'>
                <div className='container-x mx-auto'>
                    ...
                    <ul className='text-sm text-qgray py-2 leading-8 list-disc ml-10'>
                        <li className='leading-8'>You are entitled to post the Comments on our website and have all necessary licenses and consents to do so; </li>
                        <li className='leading-8'>The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party; </li>
                        <li className='leading-8'>The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy </li>
                        <li className='leading-8'>The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity. </li>
                    ...
                    <ul className='text-sm text-qgray py-2 leading-8 list-disc ml-10'>
                        <li className='leading-8'>Government agencies; </li>
                        <li className='leading-8'>Search engines; </li>
                        <li className='leading-8'>News organizations; </li>
                        <li className='leading-8'>Online directory distributors may link to our Website in the same manner as they hyperlink to the Websites of other listed businesses; and </li>
                        <li className='leading-8'>System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising groups which may not hyperlink to our Web site. </li>
                    </ul>
                    <p className='text-sm text-qgray py-2 leading-8'>These organizations may link to our home page, to publications or to other Website information so long as the link: (a)" is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and (c) fits within the context of the linking party's site.</p>
                    <p className='text-sm text-qgray py-2 leading-8'>We may consider and approve other link requests from the following types of organizations:</p>
                    <ul className='text-sm text-qgray py-2 leading-8 list-disc ml-10'>
                        <li className='leading-8'>commonly-known consumer and/or business information sources;</li>
                        <li className='leading-8'>dot.com community sites;</li>
                        <li className='leading-8'>associations or other groups representing charities;</li>
                        <li className='leading-8'>online directory distributors;</li>
                        <li className='leading-8'>internet portals; </li>
                        <li className='leading-8'>accounting, law and consulting firms; and</li>
                    ...
                    <ul className='text-sm text-qgray py-2 leading-8 list-disc ml-10'>
                        <li className='leading-8'>By use of our corporate name; or</li>
                        <li className='leading-8'>By use of the uniform resource locator being linked to; or</li>
                    ...
                    <p className='text-sm text-qgray py-2 leading-8'>Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.</p>
                    <h3 className='text-2xl font-bold'>Content Liability</h3>
                    <p className='text-sm text-qgray py-2 leading-8'>We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>
                    <h3 className='text-2xl font-bold'>Reservation of Rights</h3>
                    <p className='text-sm text-qgray py-2 leading-8'>We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it's linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.</p>
                    <h3 className='text-2xl font-bold'>Removal of links from our website</h3>
                    <p className='text-sm text-qgray py-2 leading-8'>If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.</p>
                    <p className='text-sm text-qgray py-2 leading-8'>We do not ensure that the information on this website is correct, we do not warrant its completeness or accuracy; nor do we promise to ensure that the website remains available or that the material on the website is kept up to date.</p>
                    <h3 className='text-2xl font-bold'>Disclaimer</h3>
                    <p className='text-sm text-qgray py-2 leading-8'>To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our website and the use of this website. Nothing in this disclaimer will:</p>
                    <ul className='text-sm text-qgray py-2 leading-8 list-disc ml-10'>
                        <li className='leading-8'>limit or exclude our or your liability for death or personal injury;</li>
                        <li className='leading-8'>limit or exclude our or your liability for fraud or fraudulent misrepresentation;</li>
                        <li className='leading-8'>limit any of our or your liabilities in any way that is not permitted under applicable law; or</li>
                        <li className='leading-8'>exclude any of our or your liabilities that may not be excluded under applicable law.</li>
                    </ul>
                    <p className='text-sm text-qgray py-2 leading-8'>The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are subject to the preceding paragraph; and (b) govern all liabilities arising under the disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty.</p>
                    <p className='text-sm text-qgray py-2 leading-8'>As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.</p>
                </div>
            </div>
        </div>
    )
